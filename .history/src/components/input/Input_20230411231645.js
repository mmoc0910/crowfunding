  ...
  return (
    <div className="relative">
      <input
        ...
        name
        type={type}
        className={`text-sm font-medium placeholder:text-text4 py-[15px] px-[25px] rounded-[10px] border border-solid w-full bg-inherit peer dark:placeholder:text-text2 ${className} ${
          error.length > 0
            ? "border-error text-error dark:text-white"
