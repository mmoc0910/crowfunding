  ...
  return (
    <div className="relative">
      <input
        ...
        name
        type={type}
        className={`text-sm font-medium text-text1 placeholder:text-text4 py-[15px] px-[25px] rounded-[10px] border border-solid  w-full bg-inherit peer dark:placeholder:text-text2 dark:text-white ${className} ${
          error.length > 0
            ? "border-error text-error"
            : "border-strock dark:border-dark-strock"
        }`}
