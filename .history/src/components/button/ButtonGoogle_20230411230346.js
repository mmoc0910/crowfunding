...
const ButtonGoogle = () => {
  return (
    <button className="flex items-center justify-center w-full gap-[10px] rounded-[10px] border border-solid border-strock py-3 cursor-pointer mb-5 dark:border-dark-strock">
      <IconGoogle />
