...
const PersonalInformation = () => {
  const [edit, setEdit] = React.useState(fasle);
  const {
    control,
    setValue,
    watch,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
      <div className="mb-[25px] md:mb-[35px] flex items-center justify-between">
        ...
        <button className="flex items-center gap-[10px] text-secondary20">
          <IconEdit />
      ...
      {edit && (
        <Button
          type="submit"
          className="text-white bg-primary px-[65px] mt-[25px] md:mt-[30px]"
        >
          Update
        </Button>
      )}
