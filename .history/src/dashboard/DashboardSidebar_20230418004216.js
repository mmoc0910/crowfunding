...
const DashboardSidebar = () => {
  return (
    <div className="w-1/2 lg:w-[76px] dark:shadow-none dark:bg-dark-secondary shadow-[10px_10px_20px_rgba(218,213,213,0.15)] px-0 py-0 md:py-10 md:px-[14px] rounded-none lg:rounded-[20px] flex flex-col gap-4 lg:gap-[30px] md:h-[749px]">
