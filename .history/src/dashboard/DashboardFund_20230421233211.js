...
const DashboardFund = ({ inTopBar = true }) => {
  return (
    <div className="relative">
      ...
      {inTopBar && (
        <div className=" w-[1170px] absolute z-10 right-1/2 translate-x-1/3 top-[calc(100%+45px)]">
          <div className="relative z-10 w-full grid grid-cols-3 rounded-[20px]">
          ...
          <div className="absolute z-[5] bottom-[calc(100%-20px)] right-[calc((100%/3)-58px)] text-white">
            <IconCategory />
          </div>
        </div>
      )}
