    ...
    <div className="relative z-50 max-w-[217px] md:max-w-[458px] w-full mx-auto xl:mx-0">
      ...
      <div
        className={classNames(
          "w-[calc(100vw-550px)] md:w-[calc(70vw)] absolute -translate-x-[calc(50%-9px)] lg:translate-x-0 left-1/2 lg:left-0 top-full mt-5 bg-white rounded-[20px] lg:w-[700px] xl:w-[820px] dark:bg-dark-secondary",
          isFocus ? "" : "hidden"
        )}
      >
