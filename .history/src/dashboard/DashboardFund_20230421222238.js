...
const DashboardFund = ({ inTopBar = true }) => {
  return (
    <div className="relative">
      ...
      {inTopBar && (
        <div className="w-[1170px] mt-[35px] absolute -bottom-full right-1/2 translate-x-1/3 before:absolute before:w-full before:h-[35px] before:bg-error before:bottom-full before:right-0"></div>
      )}
    </div>
  );
};
