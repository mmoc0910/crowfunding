...
const DashboardTopbar = () => {
  ...
  return (
    <div className="flex w-[calc(200%-22px)] lg:w-full mb-[30px] lg:mb-[46px]">
      <div className="flex items-center w-[calc(50%-11px)] lg:hidden order-2">
        <Link>
      ...
      <div className="flex items-center justify-between w-[calc(50%+11px)] lg:w-full order-1 lg:gap-5">
        <div className="flex items-center flex-1 lg:ml-3 lg:gap-14">
          <Link className="hidden lg:block">
            <img src="/Logo.svg" alt="" />
          </Link>
          <div className="block w-10 cursor-pointer lg:hidden">
            <IconTopBar />
          </div>
