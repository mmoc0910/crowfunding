  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="hidden lg:block absolute -z-10 bottom-[calc(100%-18px)] lg:right-[calc((33.33%/3)/2+10px)] xl:right-[calc((100%/3)-60px)] text-white dark:text-dark-secondary">
          <IconCategory />
        </div>
      </div>
      {/* )} */}
