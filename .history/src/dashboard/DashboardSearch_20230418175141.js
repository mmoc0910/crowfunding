...
const DashboardSearch = () => {
  return (
    <div className="relative max-w-[217px] md:max-w-[458px] w-full mx-auto lg:mx-0">
      ...
      <div className="absolute z-[99999] left-0 top-full mt-5 bg-black rounded-[20px] w-full md:w-[600px] lg:w-[843px] dark:bg-dark-secondary">
