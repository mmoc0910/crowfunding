  ...
  return (
    ...
    >
      ...
      {!inTopBar && (
        <div
          className={classNames(
            "lg:w-[calc(100vw-100px)] xl:w-[1170px] relative lg:absolute lg:z-10 lg:right-0 xl:right-1/2 lg:translate-x-[92px] xl:translate-x-1/3 top-[calc(100%+45px)] rounded-[20px] transition-[max-height] duration-300",
            show ? "max-h-[1000px]" : "max-h-[0px] overflow-hidden"
          )}
        >
          <div className="grid h-full w-full grid-cols-1 lg:grid-cols-3 bg-white dark:bg-darkbg lg:rounded-[20px]">
