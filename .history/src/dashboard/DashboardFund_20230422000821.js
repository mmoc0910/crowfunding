...
const DashboardFund = ({ inTopBar = true }) => {
  return (
    <div className="relative">
      ...
      {inTopBar && (
        <div className=" lg:w-[calc(100vw-100px)] xl:w-[1170px] absolute z-10 lg:right-0 xl:right-1/2 lg:translate-x-[92px] xl:translate-x-1/3 top-[calc(100%+45px)] rounded-[20px]">
          <div className="grid w-full grid-cols-3 dark:bg-darkbg dark:rounded-[20px]">
            <div className="col-span-1 lg:p-[30px_30px_80px] xl:p-[40px_40px_103px] grow-0 shrink-0 bg-white dark:bg-dark-secondary rounded-[20px_0px_0px_20px]">
            ...
            <div className="col-span-1 lg:p-[30px_30px_80px] xl:p-[40px_40px_103px] grow-0 shrink-0 bg-[#F9F9F9] dark:bg-darkbg shadow-[15px_4px_80px_rgba(198,_194,_194,_0.25)] dark:shadow-[0px_16px_30px_rgba(33,_25,_25,_0.17),_0px_30px_60px_rgba(1,_2,_9,_0.2)]">
              <h5 className="mb-5 text-sm font-semibold text-text1 dark:text-white xl:text-base">
                Creative Works
              </h5>
              <div className="grid grid-cols-2 gap-x-5 gap-y-[6px] flex-row">
            ...
            <div className="col-span-1 lg:p-[30px_30px_80px] xl:p-[40px_40px_103px] grow-0 shrink-0 bg-white dark:bg-dark-secondary rounded-[0px_20px_20px_0px]">
              <h5 className="mb-5 text-sm font-semibold text-text1 dark:text-white xl:text-base">
                Community Project
              </h5>
              <div className="grid grid-cols-2 gap-x-5 gap-y-[6px] flex-row">
                <Link className="text-sm text-text2 dark:text-text3">
                  Audio
                </Link>
                <Link className="text-sm text-text2 dark:text-text3">
                  Camera Gear
                ...
                <Link className="text-sm text-text2 dark:text-text3">Home</Link>
                <Link className="text-sm text-text2 dark:text-text3">
                  Accssories
                </Link>
                <Link className="text-sm text-text2 dark:text-text3">
          ...
          <div className="absolute -z-10 bottom-[calc(100%-18px)] lg:right-[calc((100%/3)-(20%)-62px)] xl:right-[calc((100%/3)-60px)] text-white dark:text-dark-secondary">
            <IconCategory />
          </div>
        </div>
      )}
