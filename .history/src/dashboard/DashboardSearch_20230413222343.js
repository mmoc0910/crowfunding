...
const DashboardSearch = () => {
  return (
    <div className="max-w-[458px] w-full">
      <div className="w-full p-[6px] bg-white dark:bg-dark-secondary rounded-[100px] dark:shadow-none shadow-[10px_10px_20px_rgba(218,213,213,0.15)] flex items-center">
        <div className="flex-1">
          <input
            type="text"
            className="text-sm placeholder:text-text4 p-[10px] w-full text-text1 bg-inherit"
            placeholder="Do fundrise now"
          />
        </div>

        <button className="bg-primary rounded-[20px] px-[27px] py-[11px] flex-shrink-0">
          <IconSearch />
        </button>
      </div>
    </div>
