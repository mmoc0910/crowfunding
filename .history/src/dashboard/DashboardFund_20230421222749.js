...
const DashboardFund = ({ inTopBar = true }) => {
  return (
    <div className="relative">
      ...
      {inTopBar && (
        <div className="flex items-stretch w-[1170px] mt-[35px] absolute -bottom-full right-1/2 translate-x-1/3 rounded-[20px]">
          <div className="w-390px p-[40px_40px_103px]"></div>
