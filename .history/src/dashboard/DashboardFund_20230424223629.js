        ...
        >
          {categories.length > 0 &&
            categories.map((category) => (
              <div
                className="col-span-1 p-[20px_15px_18px_20px] lg:p-[25px_30px_60px] xl:p-[35px_35px_103px] grow-0 shrink-0 bg-white dark:bg-dark-secondary even:bg-[#F9F9F9] dark:even:bg-darkbg even:shadow-[15px_4px_80px_rgba(198,_194,_194,_0.25)] dark:even:shadow-[0px_16px_30px_rgba(33,_25,_25,_0.17),_0px_30px_60px_rgba(1,_2,_9,_0.2)]"
                key={v4()}
              >
