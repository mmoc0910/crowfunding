      ...
      <div className="absolute left-0 top-full mt-5 bg-white rounded-[20px] w-full md:w-[600px] lg:w-[843px]">
        ...
        <div className="p-[25px]">
          ...
          <div className="space-y-[15px]">
            ...
            <div className="">
              <Link className="text-sm font-medium text-text2">
                <strong className="text-text1">education</strong> fund
              </Link>
              <Link className="text-sm font-medium text-text2">
                <strong className="text-text1">education</strong> fund
              </Link>
              <Link className="text-sm font-medium text-text2">
                <strong className="text-text1">education</strong> and schools
                fund
              </Link>
            </div>
          </div>
