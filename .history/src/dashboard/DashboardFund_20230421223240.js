...
const DashboardFund = ({ inTopBar = true }) => {
  return (
    <div className="relative">
      ...
      {inTopBar && (
        <div className="flex items-stretch w-[1170px] absolute z-10 top-[calc(100%+35px)] right-1/2 translate-x-1/3 rounded-[20px] bg-white">
          <div className="w-390px p-[40px_40px_103px] grow-0 shrink-0">
          ...
          <div className="w-390px p-[40px_40px_103px] grow-0 shrink-0">
            ...
            Consequuntur totam debitis expedita ratione quasi unde repudiandae
            autem tempore asperiores corrupti. Obcaecati ipsum vel enim rem
            vitae officia aperiam, quibusdam placeat!
          </div>
          <div className="w-390px p-[40px_40px_103px] grow-0 shrink-0">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam
            culpa, consectetur rem enim labore tenetur! Ipsum ut debitis
            blanditiis ea, officiis similique consequatur totam, dolorem
            dignissimos rerum, sapiente autem numquam.
          </div>
        </div>
      )}
    </div>
