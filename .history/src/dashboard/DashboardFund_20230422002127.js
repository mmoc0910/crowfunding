  ...
  return (
    <div className="relative">
      ...
      {inTopBar && (
        <div
          className={classNames(
            "md:w-[calc(100vw-100px)] xl:w-[1170px] absolute z-10 md:right-0 xl:right-1/2 md:translate-x-[92px] xl:translate-x-1/3 top-[calc(100%+45px)] rounded-[20px] transition-all duration-75",
