...
const DashboardTopbar = () => {
  return (
    <div className="flex w-[calc(200%-22px)] -translate-x-[calc(50%-11px)] lg:w-full lg:translate-x-0 mb-[30px] lg:mb-[46px]">
      <div className="flex w-[calc(50%-11px)] lg:hidden">
        <Link className="">
          <img src="/Logo.svg" alt="" />
        </Link>
        <Button
          href={"/campaign/start-campaign"}
          className="bg-secondary20 px-[20px] text-white !text-sm !min-h-[40px] !h-[40px]"
        >
          Start a campaign
        </Button>
      </div>
      <div className="flex items-center justify-between gap-[24px] md:gap-0 w-[calc(50%+11px)] lg:w-full">
        <div className="flex items-center flex-1 lg:ml-3 gap-[24px] md:gap-14">
