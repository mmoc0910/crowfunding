...
const DashboardFund = ({ inTopBar = true }) => {
  return (
    <div className="relative">
      ...
      {inTopBar && (
        <div className=" lg:w-[calc(100vw-80px)] xl:w-[1170px] absolute z-10 lg:right-0 xl:right-1/2 lg:translate-x-20 xl:translate-x-1/3 top-[calc(100%+45px)] rounded-[20px]">
