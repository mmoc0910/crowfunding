    ...
    <div className="relative">
      ...
      {inTopBar && (
        <div className="grid grid-cols-3 w-[1170px] absolute z-10 top-[calc(100%+45px)] right-1/2 translate-x-1/3 rounded-[20px] bg-white">
          <div className="border-[32.5px_0_32.5px_56.5px] border-t-[32.5px] border-r-0 border-b-[32.5px] border-l-[65px] w-0 h-0 border-t-transparent border-r-transparent border-b-transparent border-l-error bg-transparent rounded-[5px]"></div>
