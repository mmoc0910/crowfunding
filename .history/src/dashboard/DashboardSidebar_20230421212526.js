...
const DashboardSidebar = () => {
  ...
  return (
    <div className="w-1/2 md:w-[calc(350px-20px)] xl:w-[76px] pr-1 lg:pr-0">
      <div className="w-full dark:shadow-none dark:bg-dark-secondary shadow-md md:shadow xl:shadow-[10px_10px_20px_rgba(218,213,213,0.15)] px-0 py-0 xl:py-10 xl:px-[14px] rounded-lg lg:rounded-[20px] flex flex-col gap-4 lg:gap-[30px] xl:h-[749px]">
