      ...
      {inTopBar && (
        <div className="w-[1170px] absolute z-10 right-1/2 translate-x-1/3 top-[calc(100%+45px)] rounded-[20px]">
          <div className="grid w-full grid-cols-3">
            <div className="col-span-1 p-[40px_40px_103px] grow-0 shrink-0 bg-white rounded-[20px_0px_0px_20px]">
            ...
            <div className="col-span-1 p-[40px_40px_103px] grow-0 shrink-0 bg-white rounded-[0px_20px_20px_0px]">
