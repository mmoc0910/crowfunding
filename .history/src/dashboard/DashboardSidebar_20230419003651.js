        ...
        {sidebarLink.length > 0 &&
          sidebarLink.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                classNames(
                  "w-full lg:w-[48px] md:h-[48px] px-5 py-[14px] md:px-0 md:py-0 gap-5 md:gap-0 md:rounded-[10px] flex items-center md:justify-center flex-shrink-0 lg:last:bg-white dark:md:last:bg-dark-secondary dark:md:last:shadow-[10px_10px_20px_rgba(2,2,2,0.25)] md:last:shadow-[10px_10px_20px_rgba(211,211,211,0.25)] md:last:mt-[167px] last:mb-[34px] lg:last:mb-0",
                  isActive
