      ...
      {!inTopBar && (
        ...
        >
          <div className="grid w-full grid-cols-1 lg:grid-cols-3 dark:bg-darkbg lg:dark:rounded-[20px]">
            <div className="col-span-1 lg:p-[30px_30px_60px] xl:p-[40px_40px_103px] grow-0 shrink-0 bg-white dark:bg-dark-secondary lg:rounded-[20px_0px_0px_20px]">
            ...
            <div className="col-span-1 lg:p-[30px_30px_60px] xl:p-[40px_40px_103px] grow-0 shrink-0 bg-white dark:bg-dark-secondary lg:rounded-[0px_20px_20px_0px]">
              <h5 className="mb-5 text-sm font-semibold text-text1 dark:text-white xl:text-base">
                Community Project
              </h5>
              <div className="grid grid-cols-2 gap-x-5 gap-y-[6px] flex-row">
