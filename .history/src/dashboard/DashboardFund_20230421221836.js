...
const DashboardFund = ({ inTopBar = true }) => {
  return (
    <div className="relative">
      ...
      <div className="w-[1170px] mt-[35px] absolute -bottom-full right-0 translate-x-1/3 before:absolute before:w-full before:h-[35px] before:bg-error before:top-full before:right-0"></div>
    </div>
  );
};
const IconUpBig = () => {
