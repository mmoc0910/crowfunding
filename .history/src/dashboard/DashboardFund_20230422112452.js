...
const DashboardFund = ({ inTopBar = true }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(
          "lg:w-[calc(100vw-100px)] xl:w-[1170px] relative lg:absolute lg:z-10 lg:right-0 xl:right-1/2 lg:translate-x-[92px] xl:translate-x-1/3 top-[calc(100%+45px)] rounded-[20px] transition-[height] duration-500 lg:duration-[0] overflow-hidden lg:overflow-auto",
