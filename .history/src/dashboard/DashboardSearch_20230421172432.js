    ...
    <div className="relative z-50 max-w-[217px] md:max-w-[458px] w-full mx-auto lg:mx-0">
      ...
      <div
        className={classNames(
          "w-[86vw] absolute -translate-x-[calc(50%-9px)] md:translate-x-0 left-1/2 md:left-0 top-full mt-5 bg-white rounded-[20px] md:w-full lg:w-[820px] dark:bg-dark-secondary",
          isFocus ? "" : "hidden"
        )}
      >
