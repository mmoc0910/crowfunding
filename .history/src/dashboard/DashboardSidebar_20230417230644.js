...
const DashboardSidebar = () => {
  return (
    <div className="w-full md:w-[76px] dark:shadow-none dark:bg-dark-secondary shadow-[10px_10px_20px_rgba(218,213,213,0.15)] px-0 py-0 md:py-10 md:px-[14px] rounded-[20px] flex flex-col gap-[30px] md:h-[749px] w-full">
