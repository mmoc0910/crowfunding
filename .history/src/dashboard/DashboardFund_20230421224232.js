      ...
      {inTopBar && (
        <div className="grid grid-cols-3 w-[1170px] absolute z-10 top-[calc(100%+35px)] right-1/2 translate-x-1/3 rounded-[20px] bg-white">
          <div className="col-span-1 p-[40px_40px_103px] grow-0 shrink-0">
            <h5 className="mb-20 font-semibold text-text-red-100">
              Tech & Innovation
            </h5>
            <div className="flex items-start gap-x-6 gap-y-[6px] flex-row">
              <Link>Audio</Link>
              <Link>Camera Gear</Link>
              <Link>Travel & Outdoors</Link>
              <Link>Transportation</Link>
              <Link>Productivity</Link>
              <Link>Phones & Accssories</Link>
              <Link>Home</Link>
              <Link>Health & Fitness</Link>
              <Link>Food & Beverage</Link>
              <Link>Clothe & Wearables</Link>
              <Link>Green Tech</Link>
              <Link>Education</Link>
            </div>
          </div>
          <div className="col-span-1 p-[40px_40px_103px] grow-0 shrink-0">
            <h5 className="font-semibold text-text1">Creative Works</h5>
          </div>
          <div className="col-span-1 p-[40px_40px_103px] grow-0 shrink-0">
            <h5 className="font-semibold text-text1">Community Project</h5>
          </div>
        </div>
      )}
    </div>
