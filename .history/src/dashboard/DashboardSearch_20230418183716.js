...
const DashboardSearch = () => {
  return (
    <div className="relative z-50 max-w-[217px] md:max-w-[458px] w-full mx-auto lg:mx-0">
      ...
      <div className="absolute z-[40] top-0 -left-32 w-20 bg-black h-56 "></div>
      {/* <div className="absolute left-0 top-16 mt-5 bg-black rounded-[20px] w-full md:w-[600px] lg:w-[843px] dark:bg-dark-secondary">
