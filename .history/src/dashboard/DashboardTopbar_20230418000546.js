...
const DashboardTopbar = () => {
  return (
    <div className="flex w-[calc(200%-22px)] lg:w-full -translate-x-[calc(50%-11px)] lg:translate-x-0">
      <div className="block w-[calc(50%-22px)] lg:hidden">
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Autem, quis.
      </div>
      <div className="flex items-center justify-between mb-[30px] lg:mb-[46px] gap-[24px] md:gap-0 w-[calc(50%+22px)] lg:w-full">
