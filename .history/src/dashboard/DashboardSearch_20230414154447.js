    ...
    <div className="relative z-30 max-w-[458px] w-full">
      ...
      <div className="absolute left-0 top-full mt-5 bg-white rounded-[20px] w-full md:w-[600px] lg:w-[843px] dark:bg-dark-secondary">
        <div className="p-[10px] flex items-center justify-between dark:bg-dark-soft dark:rounded-[20px]">
          <h4 className="text-sm font-medium p-[10px] underline dark:text-white decoration-text1 text-text1">
            See all 10,124 fundraisier
          </h4>
          <div className="cursor-pointer w-[72px] h-[50px] flex items-center justify-center dark:bg-[#422C32] bg-[#F9E3E3] rounded-[10px]">
            <IconClose />
          </div>
        </div>
