      ...
      {inTopBar && (
        <div className="w-[1170px] absolute z-10 right-1/2 translate-x-1/3 top-[calc(100%+45px)] rounded-[20px]">
          <div className="grid w-full grid-cols-3">
            ...
            <div className="col-span-1 p-[40px_40px_103px] grow-0 shrink-0 bg-[#F9F9F9] dark:bg-darkbg shadow-[15px_4px_80px_rgba(198,_194,_194,_0.25)] shadow-[0px_16px_30px_rgba(33,_25,_25,_0.17),_0px_30px_60px_rgba(1,_2,_9,_0.2)]">
