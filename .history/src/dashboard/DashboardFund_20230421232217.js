...
const DashboardFund = ({ inTopBar = true }) => {
  return (
    <div className="relative">
      ...
      {inTopBar && (
        <div className="grid grid-cols-3 w-[1170px] absolute z-10 top-[calc(100%+45px)] right-1/2 translate-x-1/3 rounded-[20px] bg-white bg-slate-400">
          <div className="absolute bottom-[calc(100%-16px)] right-[calc((100%/3)-60px)] bg-slate-800">
            <img src="/IconTop.svg" />
          </div>
