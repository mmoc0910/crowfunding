...
const CampaignView = () => {
  ...
  return (
    <>
      ...
      >
        <span className="absolute top-4 right-4 md:top-[20px] md:right-10 w-11 h-11 flex items-center justify-center cursor-pointer text-text1 dark:text-white">
          <IconClose />
        </span>
        <h2 className="text-text1 text-xl md:text-[25px] font-bold mb-10 text-center dark:text-white">
          Back this project
        </h2>
