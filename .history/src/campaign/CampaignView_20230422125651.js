  ...
  return (
    <>
      ...
      <ReactModal
        ...
        className={
          "bg-white rounded-[20px] px-10 pt-[55px] pb-[50px] outline-none max-w-[90vw] md:max-w-[520px] w-full relative overflow-scroll max-h-[85%] scroll-hidden dark:bg-dark-secondary"
        }
      >
