  ...
  return (
    <>
      ...
      <div className="xl:w-[1066px] flex lg:flex-row flex-col gap-[10px] lg:gap-[30px] xl:gap-10 mb-[70px]">
        <div className="space-y-[30px] w-full lg:w-[calc(50%-15px)] xl:w-[583px]">
          <CampaignMainImage />
        </div>
        <div className="shrink-0 w-full flex flex-col lg:w-[calc(50%-15px)] xl:w-[445px] md:px-14 lg:px-0">
