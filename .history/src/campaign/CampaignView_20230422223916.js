  ...
  return (
    <>
      ...
      <div className="xl:w-[1066px] flex lg:flex-row flex-col gap-[10px] lg:gap-[30px] xl:gap-10 mb-[70px]">
        ...
        <div className="shrink-0 w-full flex flex-col lg:w-[calc(40%-15px)] xl:w-[445px]">
          ...
          <h1 className="mb-4 text-sm text-base font-bold md:text-xl text-text1 dark:text-white lg:text-sm">
