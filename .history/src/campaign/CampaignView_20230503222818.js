  ...
  return (
    <>
      ...
      <div className="xl:w-[1066px] flex lg:flex-row flex-col gap-[10px] lg:gap-[30px] xl:gap-10 mb-[70px]">
        <div className="space-y-[30px] w-full lg:w-[calc(60%-15px)] xl:w-[583px]">
          <CampaignMainImage />
        </div>
        <div className="shrink-0 w-full flex flex-col lg:w-[calc(40%-15px)] xl:w-[445px] md:px-14 xl:px-0">
      ...
      <div className="w-full md:pt-16 mb-[70px]">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-[124px] md:pt-7 md:px-14 xl:px-0">
