...
const CampaignView = () => {
  ...
  return (
    <>
      ...
      <div className="lg:w-[1066px] flex xl:flex-row flex-col gap-[10px] lg:gap-10 mb-[70px]">
        <div className="space-y-[30px] w-full xl:w-[583px]">
          <CampaignMainImage />
        </div>
        <div className="shrink-0 w-full flex flex-col xl:w-[445px]">
