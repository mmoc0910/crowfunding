...
const CampaignStartNew = () => {
  ...
  return (
    ...
    >
      <button className="text-text2 font-bold lg:text-[25px] flex items-center gap-[10px] bg-text4 bg-opacity-[0.08] px-6 py-3 lg:py-4 lg:px-[60px] rounded-[10px] mx-auto mb-[50px] dark:bg-dark-strock dark:text-white">
        Start a Campaign{" "}
        <img
          src="/Rectangle.svg"
          alt="Rectangle.svg"
