...
const CampaignViewAuthor = () => {
  return (
    <div className="flex items-center gap-3 md:gap-5 mb-3 md:mb-[25px]">
      <Link>
        <img
          src={defaultImg}
          alt="author"
      ...
      <div className="space-y-1">
        ...
        <div className="flex items-center gap-[10px]">
          <p className="text-xs font-semibold md:text-sm text-primary20">
            02 Campaign
          </p>
          <span className="w-[6px] h-[6px] rounded-full bg-text3"></span>
          <p className="text-xs md:text-sm text-text3">Dhaka, Bangladesh</p>
        </div>
      </div>
    </div>
  );
