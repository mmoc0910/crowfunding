  ...
  return (
    ...
    >
      ...
      <div className="space-y-[15px] lg:space-y-[35px]">
        ...
        <div className="flex items-center gap-[10px] md:gap-6 px-5 py-5 md:px-[50px] md:py-10 bg-secondary20 rounded-[10px] text-white cursor-pointer my-[25px] md:my-10">
          <Icon />
          <p className="font-bold text-xs md:text-2xl lg:text-[25px]">
