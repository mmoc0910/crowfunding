...
const CampaignStartNew = () => {
  ...
  return (
    <form
      className="pt-[25px] px-5 pb-[35px] lg:py-10 lg:pr-16 lg:pl-28 dark:bg-dark-secondary rounded-[15px] lg:rounded-[10px]"
      onSubmit={handleSubmit(onSubmit)}
    >
      <button className="text-text2 font-bold lg:text-[25px] flex items-center gap-[10px] bg-text4 bg-opacity-[0.08] px-6 py-3 lg:py-4 lg:px-[60px] rounded-[10px] mx-auto mb-5 lg:mb-[50px] dark:bg-dark-strock dark:text-white">
        Start a Campaign{" "}
        <img
          src="/Rectangle.svg"
          alt="Rectangle.svg"
      ...
      <div className="space-y-[15px] lg:space-y-[35px]">
        ...
        <div className="flex items-center gap-[10px] lg:gap-6 px-5 py-5 lg:px-[50px] lg:py-10 bg-secondary20 rounded-[10px] text-white cursor-pointer !my-10">
          <Icon />
