  ...
  return (
    <>
      ...
      <ReactModal
        ...
        className={
          "bg-white rounded-[20px] p-[24px_24px_30px] md:px-10 md:pt-[55px] md:pb-[50px] outline-none max-w-[calc(100vw-48px)] md:max-w-[520px] w-full relative overflow-scroll max-h-[85%] scroll-hidden dark:bg-dark-secondary"
        }
      >
