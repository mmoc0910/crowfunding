...
const CampaignFeature = () => {
  return (
    <div className="flex flex-col md:flex-row gap-5 md:items-center lg:gap-[30px] w-full max-w-[1048px] mb-2">
      <CampaignImage className="h-[210px] md:h-[250px] lg:h-[266px]"></CampaignImage>
