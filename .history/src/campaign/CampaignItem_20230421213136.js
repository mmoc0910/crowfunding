...
const CampaignItem = () => {
  return (
    <div className="lg:w-full bg-white shadow-[0px_2px_4px_rgba(184,184,184,0.03),0px_6px_12px_rgba(184,184,184,0.02),0px_12px_20px_rgba(184,184,184,0.03)] dark:shadow-none rounded-[15px] dark:bg-dark-secondary section-item">
