      ...
      <div className="w-full md:pt-16 mb-[70px]">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-[124px] lg:pt-7">
          ...
          <div className="max-w-[440px] w-full">
            ...
            <form className="mx-2 px-[25px] py-5 rounded-[10px] dark:bg-dark-secondary dark:shadow-none bg-white shadow-[-4px_4px_8px_rgba(226,_226,_226,_0.2),_4px_4px_8px_rgba(226,_226,_226,_0.2)] mb-[60px]">
