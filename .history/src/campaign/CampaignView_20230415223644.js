      ...
      <div className="w-full pt-24 mb-[70px]">
        ...
        <div className="flex gap-[124px] pt-7">
          ...
          <div className="max-w-[440px] w-full">
            ...
            <form className="px-[25px] py-5 rounded-[10px] dark:bg-dark-secondary bg-white shadow-[-4px_4px_8px_rgba(226,_226,_226,_0.2),_4px_4px_8px_rgba(226,_226,_226,_0.2)] mb-[60px]">
              ...
              ></Input>
              <div className="bg-[#F7F7F7] p-5 rounded-[10px] mb-5">
