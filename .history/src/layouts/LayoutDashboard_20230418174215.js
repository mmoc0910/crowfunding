...
const LayoutDashboard = () => {
  ...
  return (
    <div className="m-6 overflow-hidden md:m-10 bg-lite dark:bg-darkbg">
      <ReactModal
        isOpen={false}
        overlayClassName={
      ...
      <div className="flex lg:gap-10 w-[200%] lg:w-full -translate-x-1/2 lg:translate-x-0">
        <DashboardSidebar></DashboardSidebar>
        <div className="space-y-[30px] lg:space-y-[40px] w-1/2 lg:flex-1">
          <Outlet></Outlet>
        </div>
      </div>
    </div>
