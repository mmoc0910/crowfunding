  ...
  return (
    <div className="p-6 md:p-10 bg-lite dark:bg-darkbg">
      <ReactModal
        ...
        className={
          "bg-white rounded-[20px] px-10 pt-[55px] pb-[50px] outline-none max-w-[520px] w-full relative overflow-scroll max-h-[85%] scroll-hidden "
        }
      >
        <span className="absolute top-[20px] right-10 w-11 h-11 flex items-center justify-center cursor-pointer text-text1">
          <IconClose />
        </span>
        <h2 className="text-text1 text-[25px] font-bold mb-10 text-center">
          Back this project
        </h2>
