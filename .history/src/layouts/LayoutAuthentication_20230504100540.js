...
const LayoutAuthentication = ({ children, heading = "", ...props }) => {
  return (
    <div className="relative">
      <div className="w-full min-h-screen p-5 md:p-10 bg-lite dark:bg-darkbg">
      ...
      <div className="hidden md:block absolute w-[200%] right-1/2 translate-x-1/2 xl:w-full bottom-0 xl:right-0 h-auto z-[0]">
        <img
          src="/Ellipse.png"
          alt="background"
