...
const WithdrawPage = () => {
  return (
    <div className="flex gap-10">
      ...
      <div className="max-w-[407px] w-full shrink-0 rounded-[10px]">
        <div className="relative w-full h-[303px] rounded-[10px] bg-[linear-gradient(to_right,#7EF54D,#E7F561,#92EBFF)] bg-opacity-[0.05]"></div>
      </div>
    </div>
  );
};
