...
const WithdrawPage = () => {
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="relative lg:max-w-[407px] w-full shrink-0 rounded-[10px] overflow-hidden dark:bg-dark-secondary order-2">
        <div className="absolute top-0 right-0 w-full overflow-hidden h-[190px] lg:h-[260px] bg-[linear-gradient(to_right,#7EF54D,#E7F561,#92EBFF)]">
        ...
        <div className="relative z-[4] pt-10 px-5 pb-6 bg-transparent">
          ...
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-xl font-semibold dark:text-white">Activity</h3>
            <p className="font-semibold text-secondary">View All</p>
          </div>
...
const ActivityCard = () => {
  return (
    <div className="flex items-center gap-5">
      <div className="w-[58px] h-[58px] rounded-[10px] bg-[#8C6DFD] bg-opacity-[0.05] dark:bg-[#22202f] flex items-center justify-center">
        <img src="/525.svg" alt="" className="w-[30px] h-auto" />
      </div>
      <div className="flex items-center justify-between flex-1">
        <div className="">
          ...
          <p className="font-medium text-text4 dark:text-text3">
            31 Oct, 11:00pm
          </p>
        </div>
        <p className="text-lg font-medium text-error">$500.00</p>
      </div>
    </div>
  );
};
