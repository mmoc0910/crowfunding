...
const CheckoutPage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-[30px] md:gap-[50px] lg:gap-[135px]">
      ...
      <div className="lg:max-w-[462px] md:w-[80%] w-full p-[25px_15px] md:p-[15px_20px_40px] bg-white dark:bg-dark-secondary shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)] dark:shadow-[0px_16px_30px_rgba(33,_25,_25,_0.17),_0px_30px_60px_rgba(1,_2,_9,_0.2)] rounded-[20px]">
