  ...
  return (
    <div className="flex gap-[135px]">
      ...
      <div className="max-w-[462px] w-full p-[15px_20px_40px] bg-white dark:bg-dark-secondary shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)] dark:shadow-[0px_16px_30px_rgba(33,_25,_25,_0.17),_0px_30px_60px_rgba(1,_2,_9,_0.2)] rounded-[20px]">
        ...
        <div className="px-5 py-4 bg-opacity-[0.05] bg-secondary rounded-[10px] flex items-center justify-between mb-[15px] dark:bg-dark-strock dark:bg-opacity-50 dark:text-white">
