...
const WithdrawPage = () => {
  return (
    <div className="flex flex-col gap-5 lg:flex-row lg:gap-10">
      ...
      <div className="lg:order-1 rounded-[10px] flex-1">
        <div className="overflow-hidden pb-[25px] w-full">
          <table className="w-full table-history">
            ...
            <tbody>
              <tr>
                <th>
                  <div className="flex items-center gap-[15px]">
                    ...
                    <div className="flex flex-col items-start gap-1">
                      <Link className="text-xs font-medium text-text1">
                ...
                <th className="text-xs font-semibold text-text1">$ 5,850</th>
                <th>
                  <div className="flex items-center gap-[15px]">
                    <Link>
                      <img
