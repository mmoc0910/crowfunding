    ...
    <div className="flex gap-[135px]">
      <div className="">
        ...
        <div className="flex items-center gap-[30px]">
          <div className="w-[132px] h-[102px] shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)] bg-white dark:bg-dark-secondary dark:shadow-[0px_16px_30px_rgba(33,_25,_25,_0.17),_0px_30px_60px_rgba(1,_2,_9,_0.2)]">
            <input
              type="radio"
              name="payment_method"
              id="paypal"
