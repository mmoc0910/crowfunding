      ...
      <div className="">
        ...
        <div className="flex items-center gap-[30px]">
          <div className="w-[132px] h-[102px] shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)]">
            ...
            <label
              htmlFor="paypal"
              className="relative flex items-center justify-center w-full h-full border border-transparent bg-white rounded-[15px] cursor-pointer peer-checked:border-primary peer-checked:group"
            >
              <img src="/SeekPng 1.svg" alt="paypal" />
              <span className="absolute top-[10px] right-[10px] group:hidden">
                <IconPaypalVerified />
              </span>
            </label>
          </div>
