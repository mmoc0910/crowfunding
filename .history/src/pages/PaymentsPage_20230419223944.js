  ...
  return (
    <div className="lg:w-[624px] mx-auto pt-[66px]">
      ...
      <div className="flex space-x-10">
        <PaymentCard value={"paypal"} defaultChecked={true} />
        ...
        <div className="w-full">
          ...
          <label
            ...
            className={classNames(
              "font-semibold py-3 rounded-[10px] min-h-[52px] flex items-center justify-center select-none w-full cursor-pointer bg-[#EEEAFD]"
              // checked
              //   ? "bg-secondary20 text-white"
              //   : " text-secondary"
            )}
          >
            <span className="hidden text-white bg-secondary20 connected">
              Connected
            </span>
            <span className="bg-[#EEEAFD] text-secondary hidden connect">
              Connect
            </span>
          </label>
        </div>
