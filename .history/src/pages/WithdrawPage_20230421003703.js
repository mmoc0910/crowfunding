...
const WithdrawPage = () => {
  return (
    <div className="flex flex-col gap-5 lg:flex-row lg:gap-10">
      ...
      <div className="w-full overflow-x-scroll custom-scroll lg:overflow-auto lg:order-1">
        <div className="overflow-hidden max-w-[796px] lg:w-full pb-[25px] rounded-[10px] dark:bg-dark-secondary">
