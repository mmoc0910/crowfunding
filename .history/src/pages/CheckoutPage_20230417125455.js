...
const CheckoutPage = () => {
  return (
    <div className="flex gap-[135px]">
      ...
      <div className="p-[15px_20px_40px] bg-white shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)] rounded-[20px]">
        <h2 className="text-lg font-semibold text-text2 p-[10px] mb-[15px]">
          Contribution Summury
        </h2>
        <div className="px-5 py-4 bg-opacity-[0.05] bg-secondary rounded-[10px] flex items-center">
          <Link className="mr-[15px]">
            <img
              src={defaultImg}
              alt="...."
          ...
          <Link className="font-medium text-text1">Special One Camera</Link>
        </div>
      </div>
    </div>
  );
