...
const WithdrawPage = () => {
  return (
    <div className="flex flex-col gap-5 lg:flex-row lg:gap-10">
      ...
      <div className="relative lg:max-w-[407px] w-full shrink-0 rounded-[15px] md:rounded-[10px] overflow-hidden dark:bg-dark-secondary order-1 lg:order-2">
        ...
        <div className="relative z-[4] py-[25px] px-[15px] md:pt-10 md:px-5 pb-6 bg-transparent">
          ...
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-base font-semibold md:text-xl dark:text-white">
              Activity
            </h3>
