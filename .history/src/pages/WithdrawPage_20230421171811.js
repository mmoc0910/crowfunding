...
const WithdrawPage = () => {
  return (
    <div className="flex flex-col gap-5 xl:flex-row xl:gap-10">
      <div className="relative lg:mx-auto xl:mx-0 lg:max-w-[550px] xl:max-w-[407px] w-full shrink-0 rounded-[15px] md:rounded-[10px] overflow-hidden dark:bg-dark-secondary xl:order-2">
