...
const WithdrawPage = () => {
  return (
    <div className="flex flex-col gap-5 lg:flex-row lg:gap-10">
      ...
      <div className="relative lg:max-w-[407px] w-full shrink-0 rounded-[10px] overflow-hidden dark:bg-dark-secondary order-1 lg:order-2">
        ...
        <div className="relative z-[4] pt-10 px-5 pb-6 bg-transparent">
          <div className="mx-[76px] mb-[58px] flex flex-col items-center">
            ...
            <Button className="bg-primary text-white gap-[10px] px-[60px] text-sm md:text-base min-h-10 lg:min-h-[52px]">
              <IconDown />
              <span>Withdraw</span>
            </Button>
          </div>
