...
const PaymentCard = ({ image, children, name, id, defaultChecked = false }) => {
  return (
    <div className="p-[25px] pt-[35px] w-[292px] h-[279px] rounded-[20px] shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)]">
      <div className="flex flex-col items-center">
        ...
        <div className="w-full">
          <input type="radio" name="payment" id="paypal" className="hidden" />
          <label htmlFor="paypal" className="w-full">
            <Button className="w-full bg-[#EEEAFD]">
              <span className="hidden text-secondary">Connect</span>
