...
const WithdrawPage = () => {
  return (
    <div className="flex flex-col gap-5 xl:flex-row xl:gap-10">
      <div className="relative lg:max-w-[407px] w-full shrink-0 rounded-[15px] md:rounded-[10px] overflow-hidden dark:bg-dark-secondary xl:order-2">
      ...
      <div className="w-full overflow-x-scroll custom-scroll lg:overflow-auto xl:order-1">
        <div className="overflow-hidden w-[796px] xl:w-full pb-[25px] rounded-[10px] dark:bg-dark-secondary">
