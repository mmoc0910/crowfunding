  ...
  return (
    <div className="flex gap-10">
      ...
      <div className="relative max-w-[407px] w-full shrink-0 rounded-[10px] overflow-hidden">
        ...
        magni dicta? Praesentium autem amet similique dolor velit nobis adipisci
        assumenda dolorem. Rerum consectetur aliquam placeat maiores, reiciendis
        deleniti porro temporibus!
      </div>
    </div>
  );
};
