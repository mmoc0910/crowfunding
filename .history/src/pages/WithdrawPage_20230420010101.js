    ...
    <div className="flex gap-10">
      ...
      <div className="max-w-[407px] w-full shrink-0 rounded-[10px] overflow-hidden">
        <div className="relative w-full h-[303px] bg-[linear-gradient(to_right,#7EF54D,#E7F561,#92EBFF)]">
          <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(255,255,255,0),rgba(255,255,255,1))] bg-opacity-[0.05]">
            <img src="/background.svg" alt="" className="absolute inset-0 " />
          </div>
        </div>
      </div>
    </div>
