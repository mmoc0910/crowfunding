...
const PaymentsPage = () => {
  return (
    <div className="lg:w-[624px] mx-auto pt-[66px]">
      ...
      <div className="flex flex-col mx-auto space-x-10 md:flex-row max-w-max">
        <PaymentCard
          value={"paypal"}
          defaultChecked={true}
          image={"/SeekPng 1.svg"}
...
const PaymentCard = ({
  ...
  return (
    <div className="p-[25px] pt-[35px] w-[292px] h-[279px] rounded-[20px] shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)] dark:bg-dark-secondary dark:shadow-[0px_16px_30px_rgba(33,_25,_25,_0.17),_0px_30px_60px_rgba(1,_2,_9,_0.2)] mx-auto md:mx-0">
