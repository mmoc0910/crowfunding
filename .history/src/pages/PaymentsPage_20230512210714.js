  ...
  return (
    <RequireAuthPage>
      <div className="lg:w-[624px] mx-auto pt-[10px] md:pt-[66px]">
        ...
        <p className="text-xs md:text-base max-w-[400px] w-full md:max-w-none text-center text-text3 pb-[25px] md:pb-[60px]">
    ...
    <div className="p-5 md:p-[25px] md:pt-[35px] w-[245px] h-[208px] md:w-[292px] md:h-[279px] rounded-[15px] md:rounded-[20px] shadow-[-10px_15px_20px_rgba(231,_228,_228,_0.15),_10px_10px_20px_rgba(231,_228,_228,_0.15)] dark:bg-dark-secondary dark:shadow-[0px_16px_30px_rgba(33,_25,_25,_0.17),_0px_30px_60px_rgba(1,_2,_9,_0.2)]">
      <div className="flex flex-col items-center">
        ...
        <div className="w-full">
          ...
          <label
            htmlFor={value}
            className="text-sm md:text-base font-semibold py-[10px] md:py-3 rounded-[5px] md:rounded-[10px] min-h-10 md:min-h-[52px] flex items-center justify-center select-none w-full cursor-pointer bg-[#EEEAFD] dark:bg-[#352A65] peer-checked:before:content-['Connected'] peer-checked:before:text-white peer-checked:bg-secondary20 before:content-['Connect'] before:text-secondary before:dark:text-white"
          ></label>
        </div>
      </div>
    </div>
