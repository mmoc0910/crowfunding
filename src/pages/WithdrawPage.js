  ...
  return (
    <RequireAuthPage>
      <div className="flex flex-col gap-5 xl:flex-row xl:gap-10">
        <div className="relative xl:max-w-[407px] w-full shrink-0 rounded-[15px] md:rounded-[10px] overflow-hidden dark:bg-dark-secondary xl:order-2">
          ...
          <div className="relative z-[4] py-[25px] px-[15px] md:pt-10 md:px-5 pb-6 bg-transparent">
            <div className="mb-[25px] md:mb-[58px] flex flex-col items-center">
              ...
              <Button className="bg-primary text-white gap-[10px] px-[55px] md:px-[60px]">
                <IconDown />
                <span>Withdraw</span>
              </Button>
            </div>
            <div className="md:px-20 lg:px-24 xl:px-0">
        ...
        <div className="w-full overflow-x-scroll custom-scroll lg:overflow-auto xl:order-1">
          <div className="overflow-hidden w-[796px] lg:w-full pb-[25px] rounded-[10px] dark:bg-dark-secondary">
            <table className="w-full table-history">
              ...
              <tbody>
                <tr>
                  ...
                  <th className="text-xs font-medium text-text3">
                    Camera Gear
                  </th>
